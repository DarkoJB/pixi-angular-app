...
} from "./chunk-7KQ3QEAI.js";
import {
  getBatchSamplersUniformGroup
} from "./chunk-OUHFQVIJ.js";
import {
  BatchGeometry,
  BatchableSprite,
  Batcher,
...
function convertFillInputToFillStyle(value, defaultStyle) {
  ...
  if (value?.fill) {
    ...
    fillStyleToParse = __spreadValues(__spreadValues({}, defaultStyle), value);
  } else {
    styleToMerge = value;
  ...
  if (Color.isColorLike(styleToMerge)) {
    ...
    const opts = __spreadProps(__spreadValues({}, fillStyleToParse), {
      color: temp.toNumber(),
    ...
    return __spreadProps(__spreadValues({}, fillStyleToParse), {
      color: 16777215,
...
var _TextStyle = class _TextStyle2 extends eventemitter3_default {
  ...
  set dropShadow(value) {
    if (value !== null && typeof value === "object") {
      this._dropShadow = __spreadValues(__spreadValues({}, _TextStyle2.defaultDropShadow), value);
    } else {
      this._dropShadow = value ? __spreadValues({}, _TextStyle2.defaultDropShadow) : null;
    }
    this.update();
  }
...
var DynamicBitmapFont = class extends AbstractBitmapFont {
  /**
...
//# sourceMappingURL=chunk-6T6FAZVE.js.map
